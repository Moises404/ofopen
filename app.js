...
//displays user rules, terms and conditions
app.get('/rules', function(req, res){
  res.render('rules', {user: req.user});
});

//displays user forums
...
app.get('/toolkits', function(req, res){
  res.render('toolkits', {user: req.user});
});

//displays user competition
app.get('/competition', function(req, res){
  res.render('competition', {user: req.user});
});
